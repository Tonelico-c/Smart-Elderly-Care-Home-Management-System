...
public class MPGenerator {
    //需要配置
    private static final String dbTables = "exam_appointment,exam_appointment_item";             //需要生成的表名
    private static final Boolean enableSwagger = false;                 //是否开启Swagger

    public static void main(String[] args) {
        // 1.数据源配置
        DataSourceConfig dataSourceConfig = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/elder","root","050622").build();
        ...
        packageConfigBuilder.parent("com.situ.elder");           //项目包名
